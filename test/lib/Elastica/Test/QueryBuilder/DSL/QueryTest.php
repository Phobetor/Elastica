...
class QueryTest extends AbstractDSLTest
{
    ...
    public function testInterface()
    {
        ...
        $this->_assertImplemented($queryDSL, 'constant_score', 'Elastica\Query\ConstantScore', array(new MatchQuery()));
        $this->_assertImplemented($queryDSL, 'dis_max', 'Elastica\Query\DisMax', array());
        $this->_assertImplemented($queryDSL, 'filtered', 'Elastica\Query\Filtered', array(new MatchQuery(), new Exists('field')));
        ...
        $this->_assertImplemented($queryDSL, 'has_child', 'Elastica\Query\HasChild', array(new MatchQuery()));
        $this->_assertImplemented($queryDSL, 'has_parent', 'Elastica\Query\HasParent', array(new MatchQuery(), 'type'));
        $this->_assertImplemented($queryDSL, 'ids', 'Elastica\Query\Ids', array('type', array()));
        $this->_assertImplemented($queryDSL, 'match', 'Elastica\Query\MatchQuery', array('field', 'values'));
        ...
        $this->_assertImplemented($queryDSL, 'top_children', 'Elastica\Query\TopChildren', array(new MatchQuery(), 'type'));
